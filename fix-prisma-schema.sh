...
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}         Fixing Prisma Schema                  ${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""

cd backend/services/shared

echo -e "${GREEN}Creating corrected Prisma schema...${NC}"
...
echo -e "${GREEN}Schema fixed! Now running migrations...${NC}"
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${BLUE}================================================${NC}"
    echo ""
    echo -e "${GREEN}Your database is ready with:${NC}"
    ...
    echo ""
    echo -e "${YELLOW}View your data:${NC}"
